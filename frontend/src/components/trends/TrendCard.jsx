  ...
  return (
    <div className="bg-surface-50 dark:bg-dark-surface rounded-xl border border-surface-300 dark:border-dark-border hover:shadow-lg dark:hover:shadow-black/30 transition-all duration-300 overflow-hidden">
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            ...
            <h3
              ...
              className="text-lg font-bold text-text-primary dark:text-dark-text mb-1 cursor-pointer hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
            >
              {trend.topic}
            </h3>
          ...
          {/* Growth Chart */}
          <div className="w-24 h-16 cursor-pointer" onClick={() => onExplore?.(trend)}>
        ...
        {/* Opportunity Score */}
        <div className="mb-4 cursor-pointer" onClick={() => onExplore?.(trend)}>
